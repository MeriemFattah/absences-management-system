 ...
 */
@WebServlet("/modifierEtud")
public class modifierEtud extends HttpServlet {
	...
	private void updatepassword(HttpServletRequest request, HttpServletResponse response) 
		...
		modifier_DAOEtud.updatepassword(password);
	}
	private void selectPassword(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException, ServletException {
		int CNI = (int) getServletContext().getAttribute("username");
		String password =modifier_DAOEtud.selectpassword(CNI);
