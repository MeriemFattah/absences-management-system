...
<nav>
  <ul >
    <li><b><a href="Professor_Space">YOUR INFO</a></b></li>
    <li><b><a href="Etudiant_servlet" >STUDENTS' GRADES</a></b></li>
    <li><b><a href="UserServlet">STUDENTS ABSCENCE</a></b></li>
 
    
  </ul>
</nav>
<h2><b>WELCOME TO YOUR SPACE PROFESSOR </b></h2>
<p>!!!You have to know how to keep the ship on course!!!</p> 
<p id="paragraphe-2">TO CHANGE YOUR PASSWORD</p>       
 <script>
    function redirectToJSP() {
      window.location.href = "changeProf.jsp";
    }
  </script>      
