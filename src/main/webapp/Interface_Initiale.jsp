...
<nav>
  <ul >
    <li><b><a href="STUDENTS">STUDENTS SPACE</a></b></li>
    <li><b><a href="PROFESSORS_SPACE" >PROFESSORS SPACE</a></b></li>
    <li><b><a href="Absence">ATTENDANCE SPACE</a></b></li>
    <li><b><a href="courses">COURSES SPACE</a></b></li>
  </ul>
</nav>
<h2><b>WELCOME TO THE ADMINISTRATION SPACE</b></h2>
<p>!!!You have to know how to keep the ship on course!!!</p> 
<p id="paragraphe-2">TO CHANGE YOUR PASSWORD</p>       
 <script>
    function redirectToJSP() {
      window.location.href = "change_pass_admin.jsp";
    }
  </script>      
