...
<head>
    ...
    <title>Professor's Information</title>
    <style>
        .container {
            display: flex;
            flex-wrap: wrap;
...
<body>
	 <h1><center>Professor's Information</center></h1>
    <div class="container">
        <form action="search" method="Get">
        </form>
        <div class="input-wrapper">
            <label>CNE:</label>
            <input id="cne" type="number" name="CIN" value="${user.CIN}" readonly>
        </div>
        <div class="input-wrapper">
        ...
        <div class="input-wrapper">
            ...
            <input type="text" name="date_de_naissance" value="${user.date_de_naissance}" readonly>
        </div>
        <div class="input-wrapper">
            <label>City:</label>
            <input type="text" name="ville" value="${user.ville}" readonly>
        </div>
        <div class="input-wrapper">
